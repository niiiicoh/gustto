...
public interface AdminRestaurantsQuery :
    ...
    >
{
  ...
  public companion object {
    public val operationName: String = "AdminRestaurants"
...
public fun AdminRestaurantsQuery.ref(
...
public suspend fun AdminRestaurantsQuery.execute(
  ...
  public fun AdminRestaurantsQuery.flow(
    
    ): kotlinx.coroutines.flow.Flow<AdminRestaurantsQuery.Data> =
    ref(
